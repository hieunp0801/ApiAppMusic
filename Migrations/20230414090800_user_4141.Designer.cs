...
namespace ApiAppMusic.Migrations
{
    ...
    [Migration("20230414090800_user_4141")]
    partial class user_4141
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiAppMusic.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ApiAppMusic.Models.Playlist", b =>
                {
                    b.HasOne("ApiAppMusic.Models.ApplicationUser", "user")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiAppMusic.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
